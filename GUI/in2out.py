...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.model_label.setPixmap(QtGui.QPixmap("dl_model.jpg"))
        ...
        spacerItem10 = QtWidgets.QSpacerItem(180, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem10)
        self.load = QtWidgets.QPushButton(self.verticalLayoutWidget_5)
        self.load.setMinimumSize(QtCore.QSize(200, 0))
        self.load.setObjectName("load")
        self.horizontalLayout_3.addWidget(self.load)
        spacerItem11 = QtWidgets.QSpacerItem(80, 37, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.save.setMinimumSize(QtCore.QSize(160, 0))
