...
class Ui_Dialog(UI_widgets):
    def setupUi(self, Dialog):
        super().setupUi(Dialog)

        self._init_defaults()
        cfg = Config.fromfile('/home/huemorgen/Defect-Detection/configs/frcn/frcn_model.py')
        self._init_cfg(cfg)
    ...
    def _init_defaults(self):
        W = 400
        self.img_size = (W, W)
        self.label.setGeometry(QtCore.QRect(50, 110, *self.img_size))
    ...
    def _init_connections(self):
        ...
        self.comboBox.currentTextChanged.connect(self.combo_sig)
        ...
        self.slider.valueChanged.connect(self.update_severity)

    def _init_corruptions(self):
        self._add_curroption_to_comboBox(self.comboBox)
    ...
    def update_pixmap(self, img, augmented=False):
